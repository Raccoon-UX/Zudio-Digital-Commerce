  ...
  return (
    <html lang="en" className="h-full">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Caveat:wght@700&family=Kaushan+Script&family=Geist:wght@100..900&family=Michroma&family=Unbounded:wght@700;800;900&family=Material+Symbols+Outlined:wght,FILL@100..700,0..1&display=swap"
          rel="stylesheet"
        />
      </head>
